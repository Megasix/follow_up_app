...
class DatabaseService {
  ...
  static Future<List<RideData>> getRides(String userId) {
    return ridesCollection
        ...
        .get()
        .then<List<RideData>>(_ridesFromSnapshot);
  }
...
//get all chatrooms the signed in school has
  ...
  static List<ChatUserData> _chatUsersFromUsersSnapshot(
      QuerySnapshot<Object?> querySnapshot) {
    return querySnapshot.docs
        .map((queryDocSnap) =>
  ...
  static List<ChatMessage> _chatMessagesFromSnapshot(
      QuerySnapshot<Object?> querySnapshot) {
    return querySnapshot.docs
        .map((queryDocSnap) =>
